...
export default function ContributorsPage() {
  return (
    <div className="flex flex-col text-center gap-4 bg-neutral-100 p-8">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="rounded-2xl bg-zinc-300 p-6 text-start md:w-1/2">
          ...
          <Link href="/sign-up">
            <button className="bg-yellow-500 font-semibold mx-auto w-full rounded-xl my-4">
              Register now!
            </button>
          </Link>
        ...
        <div className="rounded-2xl bg-zinc-400 p-6 text-start md:w-1/2">
          ...
          <Link href="/video-uploader">
            <button className="bg-yellow-500 font-semibold mx-auto w-full rounded-xl mt-4">
              Upload video
            </button>
          </Link>
        </div>
