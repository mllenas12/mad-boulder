...
export default function AboutUsPage() {
  return (
    <>
      <HeadComponent
        title="About Us"
        description="Learn more about MadBoulder and our mission to make outdoor climbing accessible to everyone."
      />
      <div className="p-8 md:w-3/4 lg:w-1/2 flex flex-col gap-6 md:gap-12 text-center md:mx-auto">
        ...
        <p className="text-sm">
          We are a dedicated team working towards a future where outdoor
          climbing is accessible to everyone while creating a positive and
          sustainable impact on climbing areas and their surroundings.
        </p>
        <p className="text-sm">
          ...
          That&apos;s why our platform stands out by providing valuable
          resources that enhance the entire climbing journey. We pride ourselves
          on delivering exceptional content and adapting to the unique
          preferences and requirements of climbers.
        </p>
        ...
        <p className="text-sm">
          Join MadBoulder and make outdoor climbing sustainable and accessible
          for all!
        </p>
